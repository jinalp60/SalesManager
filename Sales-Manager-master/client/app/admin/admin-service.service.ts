...
export class AdminServiceService {
  ...
  addProductService(newProduct:Product){
    return this.http.post("http://localhost:8000/product/addProduct",{newProduct},this.getOptionsWithToken());
  }
  addCustomerService(newCustomer:Customer){
   // console.log("service client",newClient);
    return this.http.post("http://localhost:8000/customer/addCustomer",{newCustomer},this.getOptionsWithToken());
  }
  ...
  fetchProductDetailsService(){
    ...
    return this.http.get("http://localhost:8000/product/fetchProductDetails",this.getOptionsWithToken());
  }
}
